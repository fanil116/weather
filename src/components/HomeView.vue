    ...
    <div class="d-flex mt-12 flex-column flex-md-row justify-space-between">
      <div class="d-flex home__main align-start">
        <img
          ...
          alt="Icon"
        />
        <div class="home__main-temp ml-11 mr-11">{{ currentTemp }}°</div>
      ...
      <div class="d-flex flex-column forecast">
        <div
          ...
          :key="i"
          class="d-flex align-center forecast__wrapper justify-space-between"
        >
          ...
          <div class="d-flex align-center mr-8">
            <img
              ...
              alt=""
            />
            <div class="forecast__condition ml-3">
              {{ translateWeatherCondition(item.condition) }}
            </div>
          </div>
...
const translatedCondition = computed(() =>
  weatherData.value?.fact?.condition
    ? translateWeatherCondition(weatherData.value.fact.condition)
    : "—",
);
...
const forecast = computed(() => {
  ...
  return (
    weatherData.value.forecasts[0]?.hours?.filter((item) =>
